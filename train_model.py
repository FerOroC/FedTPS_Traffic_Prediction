...
from utils.utils import load_chengdu_data_new, data_loader, data_transform, evaluate_metric, evaluate_model, train_model, load_adj
...
if __name__ == '__main__':
    ...
    checkpoint_path = os.path.dirname(os.path.abspath(__file__)) +f"/checkpoints/synthetic/{city}"
